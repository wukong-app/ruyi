...
var _ contract.Converter = (*tiffToPngConverter)(nil)

// tiffToPngConverter TIFF -> PNG 文件转换器
...
func (s *tiffToPngConverter) From() contract.Concept {
	return contract.TIFF()
}

func (s *tiffToPngConverter) To() contract.Concept {
	return contract.PNG()
}

func (s *tiffToPngConverter) Params() []contract.ConverterParam {
...
func (s *tiffToPngConverter) Convert(ctx context.Context, in []byte, params map[string]string) ([]byte, error) {
