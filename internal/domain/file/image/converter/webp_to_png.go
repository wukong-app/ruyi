...
var _ contract.Converter = (*webpToPngConverter)(nil)

// webpToPngConverter WEBP -> PNG 文件转换器
...
func (s *webpToPngConverter) From() contract.Concept {
	return contract.WEBP()
}

func (s *webpToPngConverter) To() contract.Concept {
	return contract.PNG()
}

func (s *webpToPngConverter) Params() []contract.ConverterParam {
...
func (s *webpToPngConverter) Convert(ctx context.Context, in []byte, params map[string]string) ([]byte, error) {
