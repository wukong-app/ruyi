...
var _ contract.Converter = (*icoToJpegConverter)(nil)

// icoToJpegConverter ICO -> JPEG 文件转换器
type icoToJpegConverter struct {
...
func NewICOToJPEGConverter() contract.Converter {
	...
	return &icoToJpegConverter{
		params: params,
	}
}

func (s *icoToJpegConverter) From() contract.Concept {
	return contract.ICO()
}

func (s *icoToJpegConverter) To() contract.Concept {
	return contract.JPEG()
}

func (s *icoToJpegConverter) Params() []contract.ConverterParam {
...
func (s *icoToJpegConverter) Convert(ctx context.Context, in []byte, params map[string]string) ([]byte, error) {
