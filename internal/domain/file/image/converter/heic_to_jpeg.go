...
var _ contract.Converter = (*heicToJpegConverter)(nil)

// heicToJpegConverter HEIC -> JPEG 文件转换器
type heicToJpegConverter struct {
...
func (s *heicToJpegConverter) From() contract.Concept {
	return contract.HEIC()
}

func (s *heicToJpegConverter) To() contract.Concept {
	return contract.JPEG()
}

func (s *heicToJpegConverter) Params() []contract.ConverterParam {
...
func (s *heicToJpegConverter) Convert(ctx context.Context, in []byte, params map[string]string) ([]byte, error) {
