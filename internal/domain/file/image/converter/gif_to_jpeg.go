...
var _ contract.Converter = (*gifToJpegConverter)(nil)

// gifToJpegConverter GIF -> JPEG 文件转换器
...
func (s *gifToJpegConverter) From() contract.Concept {
	return contract.GIF()
}

func (s *gifToJpegConverter) To() contract.Concept {
	return contract.JPEG()
}

func (s *gifToJpegConverter) Params() []contract.ConverterParam {
...
func (s *gifToJpegConverter) Convert(ctx context.Context, in []byte, params map[string]string) ([]byte, error) {
